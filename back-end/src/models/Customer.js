...
const Customer = z.object({
  name: z
    ...
    .includes(" ", {
      message:
        "O nome teve ter um espaço em branco separando prenome e sobrenome.",
    }),
  ...
  house_number: z
    ...
    .trim()
    .min(1, {
      message: "O número do imóvel deve ter, pelo menos, 1 caractere. ",
    })
    .max(10, {
      message: "O número do imóvel pode ter, no máximo, 10 caracteres.",
    }),
